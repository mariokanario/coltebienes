...
const Logo = () => {
  ...
  return (
    <Link href='/' className='flex items-center'>
      <Image src='/images/logos/logo_coltebienesicono.png' width={31} height={40} alt='logo' />
      <LogoText
        ref={logoTextRef}
        isHovered={isHovered}
      ...
      >
        <Image src='/images/logos/logo_coltebienestext.png' width={145} height={37} alt='logo' />
      </LogoText>
    </Link>
  )
}
